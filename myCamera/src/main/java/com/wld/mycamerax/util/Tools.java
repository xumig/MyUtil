...
public final class Tools {
    ...
    public static int aspectRatio(Context mContext) {
        ...
        if (Math.abs(previewRatio - CameraConstant.DOUBLE) <= Math.abs(previewRatio - CameraConstant.DOUBLE1)) {
...
//        String cameraPath = Environment.getExternalStorageDirectory().getPath() + File.separator + "DCIM" + File.separator + "Camera";
    ...
    public static Bitmap bitmapClip(Context mContext, String imgPath, boolean front) {
        ...
        Log.d("wld__________bitmap", "width:" + bitmap.getWidth() + "--->height:" + bitmap.getHeight());  // width:3840--->height:2160  //width:2340--->height:4160
        ...
        if (bitmapRatio > screenRatio) {//胖的手机
            ...
            bitmap = Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight()-100, matrix, true);
        }
    ...
    public static boolean saveBitmap(Context mContext, String originPath, String savePath, Rect rect, boolean front) {
        ...
        try {
             clipBitmap = BitmapUtils.getBitmapFormPath(originPath,getScreenwidth(mContext), getScreenHeight(mContext));
        } catch (IOException e) {
            e.printStackTrace();
            clipBitmap = BitmapFactory.decodeFile(originPath);
        }
        ...
        if (rect != null) {
            ...
            clipBitmap = BitmapUtils.rotaingImageView(0, 270, clipBitmap);
        }
