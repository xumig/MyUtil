...
public class CameraParam implements Parcelable {
    ...
    private CameraParam startActivity(int requestCode, String title) {
        Intent intent = new Intent(mActivity, CameraActivity.class);
        intent.putExtra(CameraConstant.CAMERA_PARAM, this);
        intent.putExtra(CameraConstant.TITLE, title);
    ...
    public static class Builder {
        ...
        private int focusViewTime = 5;//焦点框显示的时长
        ...
        private int requestCode = CameraConstant.requestCode;
        ...
        public CameraParam build() {
            return new CameraParam(this).startActivity(requestCode, title);
        }
    }
