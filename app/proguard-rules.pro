...
-keep class com.indonesia.tunaifince.kt.http.model.**{*;}
...
#获取手机设备信息 mobilehardware
-dontwarn com.mobile.mobilehardware.**
-keep public class com.mobile.mobilehardware.**{*;}
...
-keep class com.hibay.livedetect.** {*;}
